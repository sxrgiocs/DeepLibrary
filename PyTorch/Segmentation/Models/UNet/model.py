...
class UNet(nn.Module):
    ...
    Ronneberger et al. https://arxiv.org/abs/1505.04597. Currently works for 3D
    images. The network is composed by 4 encoder filters which encode the
    input image, one bottleneck layer to reduce dimensionality and 4 decoder
    layers to produce the segmentation.
